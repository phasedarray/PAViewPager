#
#  Be sure to run `pod spec lint paviewpager.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Vincent.X" => "phased_array@163.com" }
  # Or just: s.author    = "Vincent.X"
  # s.authors            = { "Vincent.X" => "phased_array@sina.com" }
  # s.social_media_url   = "http://twitter.com/Vincent.X"
  ...
  s.source_files  = "PAViewPager", "PAViewPager/**/*.swift"
